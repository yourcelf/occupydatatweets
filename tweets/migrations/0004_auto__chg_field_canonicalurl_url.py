...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CanonicalUrl.url'
        db.alter_column('tweets_canonicalurl', 'url', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'CanonicalUrl.url'
        db.alter_column('tweets_canonicalurl', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
