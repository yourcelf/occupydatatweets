...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CanonicalUrl.tweet_count'
        db.add_column('tweets_canonicalurl', 'tweet_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CanonicalUrl.tweet_count'
        db.delete_column('tweets_canonicalurl', 'tweet_count')
