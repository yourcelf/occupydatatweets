...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Domain.categories'
        db.delete_column('tweets_domain', 'categories')


    def backwards(self, orm):
        
        # Adding field 'Domain.categories'
        db.add_column('tweets_domain', 'categories', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
