...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Domain.category'
        db.add_column('tweets_domain', 'category', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Domain.subcategory'
        db.add_column('tweets_domain', 'subcategory', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Domain.category'
        db.delete_column('tweets_domain', 'category')

        # Deleting field 'Domain.subcategory'
        db.delete_column('tweets_domain', 'subcategory')
    ...
    models = {
        ...
        'tweets.domain': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'subcategory': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'})
        },
        'tweets.hashtag': {
