...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CanonicalUrl.first_appearance'
        db.add_column('tweets_canonicalurl', 'first_appearance', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CanonicalUrl.first_appearance'
        db.delete_column('tweets_canonicalurl', 'first_appearance')
    ...
    models = {
        'tweets.canonicalurl': {
            ...
            'first_appearance': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
